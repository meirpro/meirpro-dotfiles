...
1. Anything not on screen is forgotten. Do not ask the reader to "keep in mind X."
2. Knowing the answer is not doing the answer. The friction between "got it" and "done it" is where work dies.
3. Starting is the hardest step. The first action must be obvious, small, and doable now.
4. Vague time estimates carry no information. "A bit of work" and "a few hours" register the same.
...
The reader should not have to hold "we are on step 3 of 5" between messages. Restate it.
